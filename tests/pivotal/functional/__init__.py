...
class PmxbotHarness:
	...
	@classmethod
	def check_for_log_msg(cls, channel='', nick='', message=''):
		assert message, "You must provide a message to use this"
		return cls.check_logs(channel=channel, nick=nick, message="%" + message + "%")
